    ...
    <div className='app-container'>
        <div className="grid place-content-center text-center h-[80vh]">
            <div className='grid gap-8'>
                ...
                <div className='mx-auto h-[260px] w-[260px] md:h-[340px] md:w-[340px] rounded-full' style={{backgroundImage:  `url("pictures/Fisayo.jpg")`, backgroundPosition: `center`, backgroundSize:`cover`}}/>
            </div>
        </div>
    </div>
  )
